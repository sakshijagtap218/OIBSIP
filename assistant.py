...
def weather_command(command):
    ...
    try:
        ...
        speak(
            "I received weather data, but could not read it."
        )
...
def wikipedia_answer(question):
    ...
    # --------------------------------------------------------
    # First try direct Wikipedia summary
    # --------------------------------------------------------
...
def calculator_command(command):
    ...
    # --------------------------------------------------------
    # Square root BEFORE operator replacement
    # --------------------------------------------------------
    ...
    if match:
        ...
        if number < 0:
            ...
            speak(
                "I cannot calculate the square root of a negative number."
            )
...
def main():
    ...
    # --------------------------------------------------------
    # If command was spoken together with wake word
    # Example:
